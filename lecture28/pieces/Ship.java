package comp110.lecture28.pieces;
...
public class Ship implements Piece {
  ...
  /*
   * If we are thrusting or torquing we will conditionally show the flames being emitted from the correct engines.
   */
  ...
  /*
   * The following code is responsible for creating the graphics of a ship. It's broken down into a few different
   * methods not too dissimilar from how we constructed emoji.
   */
