...
public class GameGUI extends Application {
  ...
  private void handleKeyPressed(KeyEvent keyEvent) {
    if (_game instanceof KeyboardHandler) {
      ...
      keyboardControllable.handleKeyPressed(new comp110.lecture28.events.KeyboardEvent(keyEvent.getCode().toString()));
    }
    keyEvent.consume();
  }
  ...
  private void handleKeyReleased(KeyEvent keyEvent) {
    if (_game instanceof KeyboardHandler) {
      KeyboardHandler keyboardControllable = (KeyboardHandler) _game;
      keyboardControllable.handleKeyReleased(new comp110.lecture28.events.KeyboardEvent(keyEvent.getCode().toString()));
    }
    keyEvent.consume();
  }
